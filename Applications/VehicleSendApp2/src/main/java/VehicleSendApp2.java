...
public class VehicleSendApp2 extends AbstractApplication<VehicleOperatingSystem> 
    ...
    private void sendAdHocBroadcast() {
       ...
       VehicleData vehicleData = getOperatingSystem().getNavigationModule().getVehicleData();
        final MessageRouting routing = getOperatingSystem()
                ...
                .topoBroadCast(1);
        final InterVehicleMsg message = new InterVehicleMsg(routing, (int) (mInt.intValue() & 0xFF), seqNum++, getOs().getPosition(), "Road CLOSED");
